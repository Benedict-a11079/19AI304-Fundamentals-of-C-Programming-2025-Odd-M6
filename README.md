...
```
# Output:
<img width="451" height="73" alt="image" src="https://github.com/user-attachments/assets/70866599-a33f-45b2-968c-808732c02e6a" />
...
```
# Output:
<img width="367" height="268" alt="image" src="https://github.com/user-attachments/assets/1239ee60-c614-4126-9128-5bd113848e89" />
...
```
# Output:
<img width="410" height="481" alt="image" src="https://github.com/user-attachments/assets/74d034aa-6647-4315-afb9-8b2edc6ce0b5" />
...
```
# Output:
<img width="486" height="160" alt="image" src="https://github.com/user-attachments/assets/6d9b28ad-8e1a-40d4-a0f5-7ebfc4c5154f" />
...
```
# Output:
<img width="235" height="70" alt="image" src="https://github.com/user-attachments/assets/073a1ba2-dbc8-4f4a-ac0d-97a291a3db2c" />
